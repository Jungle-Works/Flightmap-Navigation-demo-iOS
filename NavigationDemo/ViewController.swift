...
class ViewController: UIViewController, MGLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        mapView = NavigationMapView(frame: view.bounds, styleURL: URL(string: "https://maps.flightmap.io/styles//default.json"))
    ...
    func calculateRoute(from origin: CLLocationCoordinate2D, to destination: CLLocationCoordinate2D) {
        ...
        let directions = Directions(credentials: DirectionsCredentials(accessToken: MGLAccountManager.accessToken, host: nil))
